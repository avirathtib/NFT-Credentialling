...
export declare const EditionMetadataOutputSchema: z.ZodObject<{
    ...
    metadata: z.ZodObject<z.extendShape<z.extendShape<{
        ...
        name?: string | undefined;
        uri: string;
        id: (string | number | bigint | import("ethers").BigNumber | undefined) & (string | number | bigint | import("ethers").BigNumber);
        description?: string | undefined;
        image?: string | undefined;
        external_url?: string | undefined;
        animation_url?: string | undefined;
    ...
    supply: (string | number | bigint | import("ethers").BigNumber | undefined) & (string | number | bigint | import("ethers").BigNumber);
    metadata: {
        [x: string]: import("../..").Json;
        name?: string | undefined;
        uri: string;
...
export declare const EditionMetadataWithOwnerOutputSchema: z.ZodObject<z.extendShape<{
    ...
    supply: (string | number | bigint | import("ethers").BigNumber | undefined) & (string | number | bigint | import("ethers").BigNumber);
    owner: string;
    quantityOwned: (string | number | bigint | import("ethers").BigNumber | undefined) & (string | number | bigint | import("ethers").BigNumber);
}>;
/**
 * @internal
 */
