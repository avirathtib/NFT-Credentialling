...
export declare const VoteSettingsOuputSchema: z.ZodObject<z.extendShape<{
    ...
    voting_token_address: string;
    voting_quorum_fraction?: number | undefined;
    proposal_token_threshold: (string | number | bigint | import("ethers").BigNumber | undefined) & (string | number | bigint | import("ethers").BigNumber);
}>;
...
export declare const ProposalOutputSchema: z.ZodObject<{
    ...
    proposalId: (string | number | bigint | import("ethers").BigNumber | undefined) & (string | number | bigint | import("ethers").BigNumber);
    proposer: string;
    targets: string[];
    values: (string | number | bigint | import("ethers").BigNumber)[];
    signatures: string[];
    calldatas: string[];
    startBlock: (string | number | bigint | import("ethers").BigNumber | undefined) & (string | number | bigint | import("ethers").BigNumber);
    endBlock: (string | number | bigint | import("ethers").BigNumber | undefined) & (string | number | bigint | import("ethers").BigNumber);
    description: string;
}>;
