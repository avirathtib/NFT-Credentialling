...
var JsonConvert = /** @class */ (function () {
    ...
    Object.defineProperty(JsonConvert.prototype, "ignoreRequiredCheck", {
         ...
         */
        get: function () {
            return this.propertyConvertingMode === json_convert_enums_1.PropertyConvertingMode.IGNORE_NULLABLE;
        },
        /**
         * @deprecated
         */
        set: function (value) {
            this.propertyConvertingMode = value ? json_convert_enums_1.PropertyConvertingMode.IGNORE_NULLABLE : undefined;
        },
        enumerable: false,
        configurable: true
    });
    ...
    JsonConvert.prototype.registerClasses = function () {
        ...
        classReferences.forEach(function (classReference) {
            var key = classReference.prototype[json_convert_options_1.Settings.CLASS_IDENTIFIER] || classReference.name;
            if (key) {
    ...
    JsonConvert.prototype.convertProperty = function (expectedType, value, convertingMode, serialize) {
        ...
        if (expectedType === undefined || expectedType === any_1.Any || expectedType === null || expectedType === Object) {
            return value;
        }
        // Check if we have a nullable type
        ...
        if (expectedDimension === "2" && valueDimension === "1") {
            ...
            if (value === null && this.valueCheckingMode !== json_convert_enums_1.ValueCheckingMode.DISALLOW_NULL) {
                return null;
            }
            else if (value === null) {
        ...
        if (expectedDimension === "2" && (valueDimension === "2" || valueDimension === "1or2")) {
            ...
            if (valueDimension === "2") {
                ...
                for (var i = 0; i < value.length; i++) {
                    ...
                    array[i] = this.convertProperty(jsonType[i], value[i], this.propertyConvertingMode || json_convert_enums_1.PropertyConvertingMode.MAP_NULLABLE, serialize);
                }
                return array;
            }
            else {
                ...
                for (var key in value) {
                    ...
                    array[key] = this.convertProperty(jsonType[i], value[key], this.propertyConvertingMode || json_convert_enums_1.PropertyConvertingMode.MAP_NULLABLE, serialize);
                    i++;
                }
                return array;
            }
